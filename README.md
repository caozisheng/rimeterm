...
- **Native files + git + sysmon + session search** — zero external processes for the left column; files/git are native pure-Rust panes, sysmon and agtop are in-process monitors, and the vendored Fast Resume index/search stack powers `FR`.
