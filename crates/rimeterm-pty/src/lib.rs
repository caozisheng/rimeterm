...
pub use session::{PtyBackend, ScrollMetrics, Session, SessionConfig, SessionError, SessionOutput};
pub use shell_detect::{
    ShellChoice, classify_path, detect_all_shells, detect_default_shell, prefer_saved_shell,
};
