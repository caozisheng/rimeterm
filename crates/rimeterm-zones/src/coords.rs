...
// Vendored from zonetimeline-tui @ v0.4.0
// (https://github.com/findyourexit/zonetimeline-tui).
// The data below is public-domain (Natural Earth / IANA); the file
// packaging is MIT.
...
//! `zone1970.tab` (public domain), pinned at eggert/tz `2026a`.
//! Source: https://github.com/eggert/tz/blob/2026a/zone1970.tab
//!
