...
//! this bitmap and flushed as Unicode braille glyphs, giving a fine outline
//! that reflows with the terminal.

use crate::projection::{lat_to_norm, lon_to_norm};
...
impl BrailleCanvas {
    ...
    /// (endpoints more than half a world apart in longitude) so they don't
    /// smear a horizontal line straight across the map.
